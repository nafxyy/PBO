...
public class Posttest1 {
    ...
    public static void read() throws IOException{
        ...
        if(pemain.isEmpty()){
            ...
            for(int i = 0; i < pemain.size(); i++){
                System.out.println("Nama Pemain = " + pemain.get(i).nama);
                System.out.println("Nama Tim = " + pemain.get(i).tim);
                System.out.println("Nomor Punggung = " + pemain.get(i).nopung);
                System.out.println("Umur Pemain = " + pemain.get(i).umur);
                System.out.println("=================================");
            }
        }
    }
    ...
    public static void edit() throws IOException {
        String namabaru, timbaru;
        int nopungbaru, umurbaru;
        ...
        namabaru = buff.readLine();
        System.out.print("Masukkan Tim Baru: ");
        timbaru = buff.readLine();
        System.out.print("Masukkan Nomor Punggung Baru: ");
        nopungbaru = Integer.parseInt(buff.readLine());
        System.out.print("Masukkan Umur Baru: ");
        umurbaru = Integer.parseInt(buff.readLine());
        System.out.println("=================================");

        pemain.get(idx-1).nama = namabaru;
        pemain.get(idx-1).tim = timbaru;
        pemain.get(idx-1).nopung = nopungbaru;
        pemain.get(idx-1).umur = umurbaru;
