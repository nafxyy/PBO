// POSTTEST 5 (Abstract & Keyword)
// - Abstract Class terletak pada superclass TimBasket
// - Abstract Method terletak pada superclass TimBasket yang di override ke child class (datapelatih dan datapemain)
// - Final Class terletak pada class datapelatih dan class datapemain
// - Final Method terletak pada read()
// - Final Variabel terletak pada:
        // - variabel dpel (line 109)
        // - variabel dp (line 119)
...
public class Main {
    ...
    public static final void read(int opsi1, int opsi2) throws IOException{
        if(opsi1 == 1){
            if(pelatih.isEmpty()){
              System.out.println("=================================");
